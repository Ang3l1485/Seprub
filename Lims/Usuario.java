...
public class Usuario extends JPanel {    
    ...
    public void UsuarioGUI() {
        ...
        String[] cbCiudadItems = {"Medellín", "Envigado", "Itaguí"};

        //construct components
        btNuevoUsuario = new JButton ("Nuevo");
        btRegistrarUsuario = new JButton ("Registrar");
        btSuspender = new JButton ("Suspender");
        ...
        btSuspender.setToolTipText ("Suspender el Usuario");
        ...
        btSuspender.setBounds (770, 495, 100, 25);
        ...
        btSuspender.addActionListener((event) -> this.SuspenderUsuario()) ;
    }
